...
given"
    ...
    def test_instantiation(self):
        ...
        dict = {'_Rectangle__height': 20, '_Rectangle__width': 10,
    ...
    def test_x_y_positions(self):
        '''Tests x, y position initialization.'''
        r = Rectangle(5, 10, 15, 20)
        dict = {'_Rectangle__height': 10, '_Rectangle__width': 5,
    ...
    def test_instantiation_keyword(self):
        ...
        dict = {'_Rectangle__height': 200, '_Rectangle__width': 100,
    ...
    def test_properties(self):
        ...
        r.x = 102
        r.y = 103
        dict = {'_Rectangle__height': 101, '_Rectangle__width': 100,
    ...
    def test_validate_type(self):
        ...
        for attribute in attributes:
            st = "{} must be an integer".format(attribute)
