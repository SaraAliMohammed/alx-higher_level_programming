...
class TestSquare(unittest.TestCase):
    ...
    def test__no_args(self):
        '''Tests constructor one argument.'''
    ...
    def test_many_args(self):
        '''Tests constructor many arguments.'''
        with self.assertRaises(TypeError) as e:
            r = Square(1, 2, 3, 4, 5)
...
were given"
    ...
    def test_instantiation(self):
        ...
        dict = {'_Rectangle__height': 10, '_Rectangle__width': 10,
                '_Rectangle__x': 0, '_Rectangle__y': 0, 'id': 1}
        self.assertDictEqual(r.__dict__, dict)
    ...
    def test_position_instantiation(self):
        ...
        r = Square(5, 10, 15)
        dict = {'_Rectangle__height': 5, '_Rectangle__width': 5,
                '_Rectangle__x': 10, '_Rectangle__y': 15, 'id': 1}
        self.assertEqual(r.__dict__, dict)
    ...
    def test_instantiation_dictionary(self):
        '''Tests positional instantiation.'''
        r = Square(100, id=421, y=99, x=101)
        dict = {'_Rectangle__height': 100, '_Rectangle__width': 100,
                '_Rectangle__x': 101, '_Rectangle__y': 99, 'id': 421}
        self.assertEqual(r.__dict__, dict)

    def test_id_inherited(self):
        '''Tests if id is inherited from Base Class.'''
    ...
    def test_properties(self):
        ...
        r.x = 102
        r.y = 103
        dict = {'_Rectangle__height': 98, '_Rectangle__width': 98,
    ...
    def invalid_types(self):
        ...
        o = (3.14, -1.1, float('inf'), float('-inf'), True, "str", (2,),
             [4], {5}, {6: 7}, None)
        return o
    ...
    def test_validate_value_negative_gt(self):
        ...
        attributes = ["size"]
        for attribute in attributes:
            st = "width must be > 0".format(attribute)
            with self.assertRaises(ValueError) as e:
    ...
    def test_property_setter_getter(self):
        ...
        for attribute in attributes:
            num = randrange(10) + 1
            setattr(r, attribute, num)
            self.assertEqual(getattr(r, attribute), num)
